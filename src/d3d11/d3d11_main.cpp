...
// launchers (Rockstar, Epic, Steam) change the working directory or use
// restricted DLL search paths, which causes LoadLibrary to miss the local
// copies.  Setting the DLL directory to our own module's folder fixes this
// for any game on any GPU.
